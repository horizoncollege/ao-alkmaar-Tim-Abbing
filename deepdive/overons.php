        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
            ...
            <ul class="list-unstyled mb-0">
              <li>
                <a href="#!" class="text-dark">standpunt 1</a>
              </li>
              <li>
                <a href="#!" class="text-dark">standpunt 2</a>
              </li>
              <li>
                <a href="#!" class="text-dark">standpunt 3</a>
              </li>
              <li>
                <a href="#!" class="text-dark">standpunt 4</a>
              </li>
            </ul>
          </div>
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
            <h5 class="text-uppercase mb-0"><a href="index.php">home page</h5></a>
            <h5 class="text-uppercase mb-0">contact pagina</h5>
          </div>
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
