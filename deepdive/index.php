...
<body>
        ...
        <ul class="nav navbar-nav text-center">
          ...
          <li class="dropdown"> <!--dropdown-->
            ...
            <ul class="dropdown-menu">
              ...
              <li><button type="button" class="btn btn-outline-info"><a href="stampunt3.php">standunt 3</a></button></li>
  ...
  <body>
    ...
    <p class="text-white">stuk wit</p>
    <div class="container">
      <div class="row" >
        <div class="col-sm">
          <div class="d-block p-2 text-black" style="background-color: rgba(173, 229, 235, 1); height:150px; width: 550px; border-radius:20px; ">
            <p class="text-center p-3">voor de vissen</p>
            <p class="text-center p-3">stem op ons</p>
          </div>
        </div>
...
<img src="niemand.jpg"  alt="logo"  style="border-radius:20px; width:500px;">
</div>
\<!--footer-->
